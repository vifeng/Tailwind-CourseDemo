...
const colors1 = [
  ...
  "avocado", // bg-avocado-50 bg-avocado-100 bg-avocado-200 bg-avocado-300 bg-avocado-400 bg-avocado-500 bg-avocado-600 bg-avocado-700 bg-avocado-800 bg-avocado-900 bg-avocado-950
  ...
  "seaweed", // bg-seaweed-50 bg-seaweed-100 bg-seaweed-200 bg-seaweed-300 bg-seaweed-400 bg-seaweed-500 bg-seaweed-600 bg-seaweed-700 bg-seaweed-800 bg-seaweed-900 bg-seaweed-950
];
</script>
<template>
